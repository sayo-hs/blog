...
[**Part 1-1**: Summary of Part 1 and an overview of `heftia`]({% post_url 2025-05-17-heftia-part-1-1 %})<br>
[**Part 1-2**: The performance of `heftia`]({% post_url 2025-05-17-heftia-part-1-2  %})<br>
[**Part 1-3**: Issues with the increasingly popular `IO` monad approach]({% post_url 2025-05-17-heftia-part-1-3  %})<br>
[**Part 1-4**: Future prospects of `heftia`]({% post_url 2025-05-17-heftia-part-1-4  %})
...
Specifically, for example, it’s not possible to run `runCatch` before `runState`.
