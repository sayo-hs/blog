---
title:  "[ARCHIVE] Heftia: The Next Generation of Haskell Effects Management - Part 1.4"
author: riyo
...
The revised version of the article is currently in progress and can be found here: [{% post_url 2025-05-14-heftia-rev-part-1-4 %}]({% post_url 2025-05-14-heftia-rev-part-1-4 %})
{: .notice--warning}
