...
This article included many value judgments based on my design philosophy, which sparked discussion. [Here]({% post_url 2025-05-14-heftia-rev-part-1-2 %}) is a version with such value-laden statements removed as much as possible.
